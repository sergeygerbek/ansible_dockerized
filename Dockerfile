...
LABEL maintainer="sergey.gerbek@gmail.com" \
    ...
    org.label-schema.url="https://github.com/sergeygerbek/ansible_dockerized" \
    org.label-schema.vcs-url="https://github.com/sergeygerbek/ansible_dockerized" \
    org.label-schema.vcs-ref=$VCS_REF \
    org.label-schema.build-date=$BUILD_DATE \
    org.label-schema.docker.cmd="docker run --rm -it -v $(pwd):/ansible -v ~/.ssh/id_rsa:/root/id_rsa sergeygerbek/ansible:${ANSIBLE_VERSION_ARG} ansible-playbook --version"
